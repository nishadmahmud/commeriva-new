...
const projects = [
  ...
  { id: 30, category: "Home & Living", title: "Sevilla", logo: "https://www.sevilla-plus.com/favicon.ico", image: "/sevilla-portfolio.png", description: "Premium kitchen appliance brand website focused on chimneys, cooktops, and service-driven purchase flow.", liveLink: "https://www.sevilla-plus.com/", technologies: ["Next.js", "Tailwind"] },
  { id: 31, category: "Home & Living", title: "Verona", logo: "https://www.verona-agt.com/favicon.ico", image: "/verona-portfolio.png", description: "Kitchen appliance ecommerce experience with chimney and gas cooker catalog, warranty support, and nationwide delivery.", liveLink: "https://www.verona-agt.com/", technologies: ["Next.js", "Tailwind"] },
...
export default function Portfolio() {
  ...
  React.useEffect(() => {
    // Keep active tab in sync with current hash (e.g. when user clicks categories).
    const applyFromHash = () => {
      ...
      <div className="max-w-7xl mx-auto">
              ...
              {grouped.map(([cat, items]) => {
                ...
                return (
                  <a
                    ...
                    className={`inline-flex shrink-0 items-center gap-2 text-xs px-4 py-2 rounded-full border transition-all poppins
                      ${
                        isActive
                          ? "bg-gradient-to-r from-blue-600 to-indigo-600 border-transparent text-white shadow-md"
                          : "bg-white/80 backdrop-blur border-gray-200 text-gray-700 hover:border-gray-300 hover:text-gray-900 hover:shadow-sm"
                      }`}
                  >
              ...
              >
                {items.map((project) => (
                  ...
                  >
                    ...
                    >
                      <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:border-gray-300 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
                        {/* Media thumbnail (no play button; static image) */}
                        <div className="relative w-full aspect-[16/9] overflow-hidden bg-gray-100">
                          <ProjectImage src={project.image} alt={project.title} />
                          <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 translate-y-1 group-hover:translate-y-0 transition-all duration-300 pointer-events-none">
                            <div className="w-9 h-9 rounded-full bg-white/95 backdrop-blur-sm border border-gray-200 shadow-sm flex items-center justify-center">
                              <ExternalLink size={16} className="text-blue-600" />
                            </div>
                          </div>
                        </div>

                        {/* Bottom content like a creator/video card */}
                        <div className="p-4 flex flex-col flex-grow">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="text-xs text-gray-500 poppins truncate">
                                {project.category}
                              </p>
                            </div>
                          </div>
        ...
        >
          <div className="bg-white border border-gray-200 rounded-2xl p-10 max-w-2xl mx-auto">
            ...
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-sm font-semibold poppins transition-colors shadow-sm group"
            >
